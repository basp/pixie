namespace Pixie.Tests
{
    ...
    public class RayTests
    {
        ...
        public void TestComputePointFromDistance()
        {
            ...
            Assert.Equal(Vector4.CreatePosition(2, 3, 4), r.Position(0));
            Assert.Equal(Vector4.CreatePosition(3, 3, 4), r.Position(1));
            Assert.Equal(Vector4.CreatePosition(1, 3, 4), r.Position(-1));
            Assert.Equal(Vector4.CreatePosition(4.5, 3, 4), r.Position(2.5));
        }
